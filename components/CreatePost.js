  ...
  return (
    <div className="bg-white rounded-md shadow-md text-gray-500 p-2">
      ...
      <div className="flex justify-evenly py-2">
        <div className="flex items-center p-1 space-x-1 flex-grow justify-center hover:bg-gray-200 rounded-md hover:cursor-pointer">
        ...
        <div
          onClick={handleClick}
          className="flex items-center p-1 space-x-1 flex-grow justify-center hover:bg-gray-200 rounded-md hover:cursor-pointer"
        >
